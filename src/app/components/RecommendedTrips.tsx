...
export async function RecommendedTrips() {
  ...
  return (
    <div className="container mx-auto mb-14 mt-5 w-full px-5 md:my-14">
      <h2
      ...
      {/* <div className="mt-5 flex flex-col items-center gap-5 md:mt-10 md:flex-row md:flex-wrap md:items-start md:justify-center md:gap-10"> */}
